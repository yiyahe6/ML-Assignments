...
def test_preprocess():
    ...
    std = transformed["std"]
    # print(mean, std)
    # print(trans_data[0:2,:])
    to_verify = verify(X)
    data_verify = to_verify[0]
    mean_verify = to_verify[1]
    std_verify = to_verify[2]
    # print(to_verify[0:2,:])
    print(trans_data - data_verify)
    print(mean - mean_verify)
    print(std - std_verify)
def gen_line_data(sample_num=5):
    """
    y = 3*x1 + 4*x2
    :return:
    """
